...
HISTORY_SECONDS = 1.2
MOTION_SCALE = 8000.0
# فقط اگر چهره زنده‌تر از این مقدار باشد، تطبیق انجام می‌شود
LIVENESS_THRESHOLD = 60.0
SIMILARITY_THRESHOLD = 0.45  # آستانه شباهت InsightFace
...
app.prepare(ctx_id=-1)  # برای macOS از CoreML/CPU
print("✅ Model loaded.\n")
...
print("✅ Starting combined Liveness + Face Recognition pipeline...\n")
...
with mp_face.FaceMesh(
    ...
    while True:
        ...
        # --- هر UPDATE_INTERVAL ثانیه یک‌بار ---
        ...
        # --- فقط اگر چهره زنده و واقعی بود ---
        if final_score >= LIVENESS_THRESHOLD and face_found and face_roi is not None:
            faces = app.get(frame)
            for face in faces:
...
print("🧠 Combined recognition stopped.")
